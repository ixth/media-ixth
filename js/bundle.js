...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ModelsPlaylist = __webpack_require__(2);

	var _ModelsPlaylist2 = _interopRequireDefault(_ModelsPlaylist);

	var _ModelsVkApi = __webpack_require__(36);

	var _ModelsVkApi2 = _interopRequireDefault(_ModelsVkApi);

	var api = new _ModelsVkApi2['default']();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vkApi = __webpack_require__(36);

	var _vkApi2 = _interopRequireDefault(_vkApi);

	var Playlist = (function (_Collection) {
	    _inherits(Playlist, _Collection);
	    ...
	    _createClass(Playlist, [{
	        ...
	        key: 'sync',
	        value: function sync(method, collection, options) {
	            if (method === 'read') {
	                _vkApi2['default'].getAudio({
	                    offset: this._offset,
	                    count: 10
	                }).then(this._onReadSuccess.bind(this, collection, options), this._onReadFailure.bind(this, collection, options));
	            }
	            collection.trigger('request', collection, null, options);
	        }
	    }, {
	        key: '_onReadSuccess',
	        value: function _onReadSuccess(collection, options, response) {
	        ...
	        key: '_onReadFailure',
	        value: function _onReadFailure(collection, options, error) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Track = (function (_Model) {
	  _inherits(Track, _Model);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _domCreate = __webpack_require__(78);

	var _domCreate2 = _interopRequireDefault(_domCreate);
	    ...
	    _createClass(VKAPI, [{
	        ...
	        value: function init() {
	            ...
	            return new _Promise(function (resolve, reject) {
	                VK.init(function () {
	                    _this._checkPermissions(VKAPI.P_FRIENDS | VKAPI.P_AUDIO);
	                }, reject, '5.37');
	            });
	        }
	    }, {
	        ...
	        key: '_isApiInjected',
	        value: function _isApiInjected(document) {
	            return true;
	        }
	    }, {
	        key: '_checkPermissions',
	        value: function _checkPermissions(neededPermissions) {
	            VK.api('account.getAppPermissions', {}, function (_ref) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var setUnscope = __webpack_require__(58)
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S + $def.F * !(useNative && __webpack_require__(77)(function(iter){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(C){
	  if(__webpack_require__(48) && !(SPECIES in C))$.setDesc(C, SPECIES, {
	    configurable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $redef = __webpack_require__(45);
